...
public:
	...
	Student(PIB pib, Date b, string p,string c, string country,string u, 
		string u_ci,string u_country,string group)
	{
		cout << "parametrized constructor" << endl;
		this->fullname = pib;
		this->birthdate = b;
...
int main()
{
	...
	cout << "-----------------------------------" << endl;
	Student  st2("Oleg", "Mukoluk", "Petrovich", {1,1,1995});//parametrized constructor
	st2.Print();

	cout << "-----------------------------------" << endl;
	Student  st3({ "Lilia", "Vunnuchuk", "Vasulivna" }, { 7,12,2000 },
